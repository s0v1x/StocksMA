...
class CompanyInfo(NamedTuple):
    ...
    Attributes:
        ...
        other_name (str): An alternative name for the company.
        isin (str): The International Securities Identification Number (ISIN) for the company.
    """
...
COMPANIES = MappingProxyType(
    {
        ...
        "AFM": CompanyInfo(name="AFMA S.A.", other_name="AFMA P", isin="MA0000012296"),
        "AFI": CompanyInfo(
            name="Afric Industries S.A.", other_name="Afric Indus.", isin="MA0000012114"
        ),
        "GAZ": CompanyInfo(
            name="Afriquia Gaz", other_name="Afriquia Gaz P", isin="MA0000010951"
        ),
        "AGM": CompanyInfo(name="Agma S.A.", other_name="Agma P", isin="MA0000010944"),
        "ADI": CompanyInfo(
            name="Alliances Developpement Immobilier S.A.",
            other_name="Alliances P",
            isin="MA0000011819",
        ),
        "ALM": CompanyInfo(
            name="Aluminium du Maroc",
            other_name="Aluminium Maroc P",
            isin="MA0000010936",
        ),
        "ARD": CompanyInfo(
            name="Aradei Capital", other_name="Aradei Capital", isin="MA0000012460"
        ),
        "ATL": CompanyInfo(
            name="AtlantaSanad", other_name="ATLANTA P", isin="MA0000011710"
        ),
        "ATW": CompanyInfo(
            name="Attijariwafa Bank",
            other_name="Attijariwafa Bank",
            isin="MA0000012445",
        ),
        "ATH": CompanyInfo(
            name="Auto Hall S.A.", other_name="Auto Hall P", isin="MA0000010969"
        ),
        "NEJ": CompanyInfo(
            name="Auto Nejma Maroc S.A.", other_name="Auto Nejma P", isin="MA0000011009"
        ),
        "BAL": CompanyInfo(
            name="Societe Immobiliere Balima",
            other_name="BALIMA P",
            isin="MA0000011991",
        ),
        "BOA": CompanyInfo(
            name="Bank of Africa", other_name="Bank Of Africa", isin="MA0000012437"
        ),
        "BCP": CompanyInfo(
        ...
        "CRS": CompanyInfo(
            name="Cartier Saada S.A.", other_name="Cartier Saada P", isin="MA0000011868"
        ),
        "CDM": CompanyInfo(
            name="Credit du Maroc", other_name="CDM P", isin="MA0000010381"
        ),
        "CDA": CompanyInfo(
            name="Centrale Danone", other_name="Central.Danone P/N", isin="MA0000012049"
        ),
        "CIH": CompanyInfo(
        ...
        "CMA": CompanyInfo(
            name="Les Ciments du Maroc", other_name="Ciments Maroc", isin="MA0000010506"
        ),
        "CMT": CompanyInfo(
            name="Compagnie Miniere de Touissit S.A.",
            other_name="CMT",
            isin="MA0000011793",
        ),
        "COL": CompanyInfo(
            name="Colorado S.A.", other_name="Colorado P", isin="MA0000011934"
        ),
        "CSR": CompanyInfo(name="Cosumar", other_name="COSUMAR", isin="MA0000012247"),
        "CTM": CompanyInfo(
        ...
        "DRI": CompanyInfo(
            name="DARI COUSPATE", other_name="DARI COUSPATE", isin="MA0000011421"
        ),
        "DLM": CompanyInfo(
            name="Delattre Levivier Maroc S.A.",
            other_name="Delattre Lev. P",
            isin="MA0000011777",
        ),
        "DHO": CompanyInfo(
            name="Delta Holding S.A.", other_name="Delta Holding P", isin="MA0000011850"
        ),
        "DIS": CompanyInfo(
            name="DIAC SALAF", other_name="DIAC SALAF", isin="MA0000010639"
        ),
        "DWY": CompanyInfo(
            name="Disway S.A.", other_name="DISWAY P", isin="MA0000011637"
        ),
        "NKL": CompanyInfo(
            name="Ennakl Automobiles", other_name="Ennakl N", isin="MA0000011942"
        ),
        "EQD": CompanyInfo(
            name="Societe d'Equipement Domestique et Menager S.A. ",
            other_name="EQDOM P",
            isin="MA0000010357",
        ),
        "FBR": CompanyInfo(
            name="Fenie Brossette S.A.",
            other_name="FENIE BROSSETTE P",
            isin="MA0000011587",
        ),
        "HPS": CompanyInfo(
        ...
        "IBC": CompanyInfo(
            name="IB Maroc.com S.A.", other_name="IBMaroc.com P", isin="MA0000011132"
        ),
        "IMO": CompanyInfo(
            name="Immorente Invest S.A.",
            other_name="Immr Invest P",
            isin="MA0000012387",
        ),
        "INV": CompanyInfo(name="Involys", other_name="INVOLYS P", isin="MA0000011579"),
        "JET": CompanyInfo(
            name="Jet Contractors S.A.",
            other_name="Jet Contractors P",
            isin="MA0000012080",
        ),
        "LBV": CompanyInfo(
            name="Label Vie", other_name="LABEL VIE P", isin="MA0000011801"
        ),
        "LHM": CompanyInfo(
            name="LafargeHolcim Maroc",
            other_name="LafargeHolcim P",
            isin="MA0000012320",
        ),
        "LES": CompanyInfo(
            name="Lesieur Cristal S.A.",
            other_name="Lesieur Cristal",
            isin="MA0000012031",
        ),
        "M2M": CompanyInfo(
            name="m2m group S.A.", other_name="M2M Group P", isin="MA0000011678"
        ),
        "MOX": CompanyInfo(
            name="Maghreb Oxygene", other_name="Maghreb Oxygene P", isin="MA0000010985"
        ),
        "MAB": CompanyInfo(
            name="Maghrebail", other_name="Maghrebail P", isin="MA0000011215"
        ),
        "MNG": CompanyInfo(name="Managem", other_name="Managem P", isin="MA0000011058"),
        "MLE": CompanyInfo(
            name="Maroc Leasing S.A.", other_name="Maroc Leasing N", isin="MA0000010035"
        ),
        "IAM": CompanyInfo(
            name="Maroc Telecom", other_name="Maroc Telecom", isin="MA0000011488"
        ),
        "MDP": CompanyInfo(
            name="Med Paper S.A.", other_name="Med Paper P", isin="MA0000011447"
        ),
        "MIC": CompanyInfo(
            name="Microdata S.A.R.L.", other_name="Microdata N", isin="MA0000012163"
        ),
        "MUT": CompanyInfo(
            name="Mutandis SCA", other_name="Mutandis Br", isin="MA0000012395"
        ),
        "OUL": CompanyInfo(name="OULMES", other_name="OULMES", isin="MA0000010415"),
        "PRO": CompanyInfo(
            name="Promopharm S.A.", other_name="PROMOPHARM", isin="MA0000011660"
        ),
        "REB": CompanyInfo(
            name="REBAB COMPANY", other_name="REBAB COMPANY", isin="MA0000010993"
        ),
        "RDS": CompanyInfo(
            name="Residences Dar Saada S.A.",
            other_name="Resid Dar Saada P",
            isin="MA0000012239",
        ),
        "S2M": CompanyInfo(
            name="Societe Maghrebine de Monetique",
            other_name="S2M P",
            isin="MA0000012106",
        ),
        "SAH": CompanyInfo(
            name="Saham Assurance S.A.",
            other_name="Saham Assurance N",
            isin="MA0000012007",
        ),
        "SLF": CompanyInfo(name="Salafin", other_name="SALAFIN P", isin="MA0000011744"),
        "SAM": CompanyInfo(name="SAMIR", other_name="SAMIR", isin="MA0000010803"),
        "SMI": CompanyInfo(
            name="Societe Metallurgique d'Imiter ",
            other_name="SMI P",
            isin="MA0000010068",
        ),
        "SNA": CompanyInfo(
            name="Stokvis Nord Afrique", other_name="SNA P", isin="MA0000011843"
        ),
        "SNP": CompanyInfo(
            name="Societe Nationale d'Electrolyse et de Petrochimie ",
            other_name="SNEP P",
            isin="MA0000011728",
        ),
        "MSA": CompanyInfo(
            name="SODEP-Marsa Maroc", other_name="SODEP P", isin="MA0000012312"
        ),
        "SID": CompanyInfo(
            name="Societe Nationale de Siderurgie S.A.",
            other_name="Sonasid P",
            isin="MA0000010019",
        ),
        "SOT": CompanyInfo(name="Sothema", other_name="SOTHEMA", isin="MA0000012502"),
        "SRM": CompanyInfo(
            name="Societe de Realisations Mecaniques",
            other_name="SRM P",
            isin="MA0000011595",
        ),
        "SBM": CompanyInfo(
            name="Societe des Boissons du Maroc",
            other_name="Ste Boissons P",
            isin="MA0000010365",
        ),
        "STR": CompanyInfo(
            name="STROC Industrie S.A.",
            other_name="STROC Indus. P",
            isin="MA0000012056",
        ),
        "TQM": CompanyInfo(
            name="Taqa Morocco", other_name="TAQA Morocco P", isin="MA0000012205"
        ),
        "TIM": CompanyInfo(
            name="TIMAR S.A.", other_name="Timar P", isin="MA0000011686"
        ),
        "TMA": CompanyInfo(
            name="TotalEnergies Marketing Maroc",
            other_name="Total Maroc P",
            isin="MA0000012262",
        ),
        "UMR": CompanyInfo(name="UNIMER", other_name="UNIMER", isin="MA0000012023"),
        "WAA": CompanyInfo(
            name="Wafa Assurance S.A.", other_name="Wafa Assur P", isin="MA0000010928"
        ),
        "ZDJ": CompanyInfo(
            name="Zellidja S.A.", other_name="Zellidja P", isin="MA0000010571"
        ),
        "AKT": CompanyInfo(name="AKDITAL", other_name="aktidal", isin="MA0000012585"),
        "DYT": CompanyInfo(
            name="DISTY TECHNOLOGIES",
            other_name="disty technolog p",
            isin="MA0000012536",
        ),
        "TGC": CompanyInfo(name="TGCC S.A", other_name="TGCC P", isin="MA0000012528"),
        "RIS": CompanyInfo(name="RISMA", other_name="RISMA", isin="MA0000011462"),
    }
)
...
SECTORS = {
    ...
    "ASSURANCES": "1356466%2C102%2C608",
    "BANQUES": "1356464%2C102%2C608",
    "BATIMENT & MATERIAU": "1356394%2C102%2C608",
    "BOISSONS": "1356457%2C102%2C608",
    "CHIMIE": "1356391%2C102%2C608",
    "DISTRIBUTEURS": "1356461%2C102%2C608",
    "EQUIPEMENTS EL & EL": "1356399%2C102%2C608",
    "IMMOBILIER": "1356469%2C102%2C608",
    "INDICE MADEX": "1356356%2C102%2C608",
    "INDICE MASI": "1356351%2C102%2C608",
    "INDUSTRIE PHARMACEU": "2245830%2C102%2C608",
    "INGENIERIES & BEIND": "10896131%2C102%2C608",
    "LOISIRS ET HOTELS": "2792496%2C102%2C608",
    "MAT LOG & SVC INFOR": "1356472%2C102%2C608",
    "MINES": "1356386%2C102%2C608",
    "PETROLE ET GAZ": "1356388%2C102%2C608",
    "SERVICES AUX COLLEC": "2245852%2C102%2C608",
    "SOC FINAN & ACT FIN": "1356470%2C102%2C608",
    "SOCIETES PORT HOL": "1356467%2C102%2C608",
    "SYLVICULTURE & PAP": "1356396%2C102%2C608",
    "TELECOMMUNICATIONS": "2245821%2C102%2C608",
    "TRANSPORTS": "1356463%2C102%2C608",
}
